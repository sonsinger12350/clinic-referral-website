	...
	*/
	public function render_notice_content() {
		...
		<div class="welcome-message" style="<?php echo esc_attr($flex_attr); ?>">
			...
			<p>
				<?php echo sprintf( esc_html__( 'Royal Elementor Kit comes with %s with various designs to pick from.', 'royal-elementor-kit' ), '<strong><a href="https://demosites.royal-elementor-addons.com/elementor-templates/?ref=royal-elementor-theme-wellcome-banner" target="_blank">Elementor based 60+ sites library </a></strong>' ); ?>
